...
export class RecipeService {
  ...
  getAllRecipes() {
    for (let index = 0; index < this.breakfastRecipes.length; index++) {
      if (!this.allRecipes.includes(this.breakfastRecipes[index])) {
        this.allRecipes.push(this.breakfastRecipes[index]);
      }
    }
    for (let index = 0; index < this.mainCourseRecipes.length; index++) {
      if (!this.allRecipes.includes(this.mainCourseRecipes[index])) {
        this.allRecipes.push(this.mainCourseRecipes[index]);
      }
    }
    for (let index = 0; index < this.dessertRecipes.length; index++) {
      if (!this.allRecipes.includes(this.dessertRecipes[index])) {
        this.allRecipes.push(this.dessertRecipes[index]);
      }
    }
  ...
  addFavoriteRecipes(favoriteRecipe: any) {
